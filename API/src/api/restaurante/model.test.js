...
beforeEach(async () => {
  restaurante = await Restaurante.create({ nombre: 'test', calle: 'test', descripcion: 'test', localizacion: 'test', horario: 'test', cod_post: 'test' })
})
...
describe('view', () => {
  it('returns simple view', () => {
    ...
    expect(view.cod_post).toBe(restaurante.cod_post)
